...
describe('Service Tests', () => {
    ...
    describe('AppMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AppMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return AppMySuffix', () => {

                let entity: AppMySuffix;
                service.find(123).subscribe((_entity: AppMySuffix) => {
                    entity = _entity;
                });
