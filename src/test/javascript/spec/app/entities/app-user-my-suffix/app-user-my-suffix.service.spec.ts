...
describe('Service Tests', () => {
    ...
    describe('AppUserMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AppUserMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/app-users';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AppUserMySuffix', () => {

                let entity: AppUserMySuffix;
                service.find(123).subscribe((_entity: AppUserMySuffix) => {
                    entity = _entity;
                });
