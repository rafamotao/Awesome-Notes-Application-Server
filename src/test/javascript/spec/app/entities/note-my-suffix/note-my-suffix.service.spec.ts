...
describe('Service Tests', () => {
    ...
    describe('NoteMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(NoteMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return NoteMySuffix', () => {

                let entity: NoteMySuffix;
                service.find(123).subscribe((_entity: NoteMySuffix) => {
                    entity = _entity;
                });
